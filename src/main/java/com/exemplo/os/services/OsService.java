...
public class OsService {
	...
	private OS fromDTO(OSDTO obj) {
		...
		newObj.setPrioridade(Prioridade.toEnum(obj.getPrioridade())); //tem que transformar de integer (código) para stream (nome)
		newObj.setStatus(Status.toEnum(obj.getStatus())); //tem que transformar de integer (código) para stream (nome)
